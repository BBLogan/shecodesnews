...
class NewsStory(models.Model):
    ...
    title = models.CharField(max_length=200, help_text="Enter the title of the news story")
...
class Comment(models.Model):
    ...
    author = models.ForeignKey(get_user_model(), on_delete=models.CASCADE, help_text="Author of the news story", null=True)
